...
This is a continuation of the Lesson 4 Prove assignment. Instead of one factory and one dealership, will have multiple of each; the last prove lesson was a one-to-one relationship but this lesson will be a many-to-many relationship. The restriction of only producing `MAX_QUEUE_SIZE` is still in place for all of the dealerships.
